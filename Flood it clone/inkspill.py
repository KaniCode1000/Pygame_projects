...
#Thanks to Al Stewgart for the tutorial
#author : CODERKANI
...
def main():
    ...
    SETTINGSIMAGE.set_colorkey(BLACK)
    ...
    pygame.display.set_icon(SPOTIMAGE)
    mousex = 0
    mousey = 0
        ...
        for event in pygame.event.get(): # event handling loop
            if event.type == QUIT:
                ...
                # check for clicks on the size buttons
                    ...
                    webbrowser.open('https://technology-support.netlify.app') # opens a web browser
